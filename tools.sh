...
main_menu() {
    while true; do
        ...
        echo "╠════════════════════════════════════════╣"
        echo "║  Caddy 反向代理                         ║"
        echo "║  [10] 安装 Caddy (8443)                ║"
        echo "║  [11] 添加反代路由                      ║"
        echo "║  [12] 管理反代路由                      ║"
        echo "╠════════════════════════════════════════╣"
        echo "║  环境安装                               ║"
        echo "║  [14] 安装 Docker                      ║"
        echo "║  [15] 安装 Docker Compose              ║"
        echo "║  [16] 防火墙管理                        ║"
        echo "╠════════════════════════════════════════╣"
        echo "║  网络工具                               ║"
        echo "║  [17] 安装 Tailscale                   ║"
        echo "║  [18] 配置 Exit Node                   ║"
        echo "╠════════════════════════════════════════╣"
        echo "║  面板工具                               ║"
        echo "║  [19] 安装 1Panel 面板                 ║"
        echo "╠════════════════════════════════════════╣"
        echo "║  系统配置                               ║"
        echo "║  [20] 调整时区                          ║"
        echo "║  [21] 启用 Root SSH 密码               ║"
        echo "╠════════════════════════════════════════╣"
        echo "║  云同步                                 ║"
        echo "║  [22] ☁️  配置 GitHub Gist 同步        ║"
        echo "╠════════════════════════════════════════╣"
        echo "║  [0] 退出                              ║"
        echo "╚════════════════════════════════════════╝"
        echo ""
...
enable_root_ssh() {
    clear
    echo "╔════════════════════════════════════════╗"
    echo "║        启用 Root SSH 密码登录           ║"
    echo "╚════════════════════════════════════════╝"
    echo ""
    
    check_root
    
    print_warning "此操作将允许 root 用户通过密码登录 SSH"
    echo ""
    ...
    log_action "Enable root SSH password login"
